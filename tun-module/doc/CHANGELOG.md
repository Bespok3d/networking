...
The TUN kernel module is now a stable plugin. Before, it only showed up in the store if you had set
your plugin channel to testing; now it shows for everyone. Nothing about the module itself changed.
